 ...
 console.log('resData', resData.info);
  return (
    <div className="res-card-wrapper" style={cardStyle}>
      <img
        src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + resData.info.cloudinaryImageId}        className="res-logo"
        alt="res-logo"
      />
      <div className="res-details">
        ...
        <div className="res-rating-wrapper">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe_MsK9z8K6n5lH2o6jT_ZQsmasOVr_4saO_Bf6kabZA&s"
            alt="star"
            className="star"
          />
          <p className="res-rating">{resData.info.avgRating} stars</p>
          <p className="res-delivery-time">{resData.info.sla.slaString}</p>
        </div>
        <p className="res-cost">{resData.info.costForTwo}</p>
        <p className="res-cuisine">{resData.info.cuisines}</p>
        <p className="res-location">{resData.info.locality}</p>
      </div>
    </div>
  );
};
...
const resList =  [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-04-14 02:59:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-04-13 21:00:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      "info": {
        ...
        "cloudinaryImageId": "fbd0e1ca609317efa4e0a5d7576643c5",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/royce-chocolate-vittal-mallya-road-bangalore-48338",
        "type": "WEBLINK"
      }
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-04-13 22:45:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
